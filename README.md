...
Step 2: Initialize system peripherals, clock, and HAL components.  
Step 3: Configure GPIO Port A pins (PA0 to PA6) as output push-pull mode.  
Step 4: Define the 7-segment hex code lookup array for digits 0 to 9.  
Step 5: Start an infinite loop (while(1)).  
Step 6: Set loop counter variable i = 0.  
Step 7: Read the pattern digitCode[i].  
Step 8: Check each bit (Bit 0 to Bit 6) of digitCode[i].  
Step 9: Output high (1) or low (0) to pins PA0 through PA6 based on corresponding bit values.  
Step 10: Wait for 100 milliseconds using HAL_Delay().  
Step 11: Increment i by 1.  
Step 12: If i < 10, repeat from Step 7; otherwise, reset i = 0 and continue.  
Step 13: Stop (program loop continues indefinitely).  
...
<img width="576" height="577" alt="WhatsApp Image 2026-09-13 at 2 12 05 PM(1)" src="https://github.com/user-attachments/assets/0f0f8d92-2f20-4656-9803-e0a542f6cf41" />
